    ...
    setup: (app, db, endpoint, endpoints) => {
        ...
        app.get(endpoint, (req, res) => {
            var endpoints = [
                ...
                {'path':'/rulebook/:rid/class', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Classes', 'alias':'rulebook-id-class'},
                {'path':'/rulebook/:rid/class/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Class', 'alias':'rulebook-id-class-id'},
				{'path':'/rulebook/:rid/feat', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Feats', 'alias':'rulebook-id-feat'},
                {'path':'/rulebook/:rid/feat/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Feat', 'alias':'rulebook-id-feat-id'},
				{'path':'/rulebook/:rid/monster', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Monsters', 'alias':'rulebook-id-monster'},
                {'path':'/rulebook/:rid/monster/:pid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Monster', 'alias':'rulebook-id-monster-id'},
				{'path':'/rulebook/:rid/race', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Races', 'alias':'rulebook-id-race'},
                {'path':'/rulebook/:rid/race/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Race', 'alias':'rulebook-id-race-id'},
				{'path':'/rulebook/:rid/spell', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Spells', 'alias':'rulebook-id-spell'},
                {'path':'/rulebook/:rid/spell/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Spell', 'alias':'rulebook-id-spell-id'},
