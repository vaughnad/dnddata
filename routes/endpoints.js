    ...
    setup: (app, db, endpoint, endpoints) => {
        ...
        app.get(endpoint, (req, res) => {
            var endpoints = [
                ...
                {'path':'/rulebook/:rid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook', 'alias':'rulebook-id'},
                {'path':'/rulebook/:rid/class', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Classes', 'alias':'rulebook-rid-class'},
                {'path':'/rulebook/:rid/class/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Class', 'alias':'rulebook-rid-class-sid'},
				{'path':'/rulebook/:rid/feat', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Feats', 'alias':'rulebook-rid-feat'},
                {'path':'/rulebook/:rid/feat/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Feat', 'alias':'rulebook-rid-feat-sid'},
				{'path':'/rulebook/:rid/monster', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Monsters', 'alias':'rulebook-rid-monster'},
                {'path':'/rulebook/:rid/monster/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Monster', 'alias':'rulebook-rid-monster-sid'},
				{'path':'/rulebook/:rid/race', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Races', 'alias':'rulebook-rid-race'},
                {'path':'/rulebook/:rid/race/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Race', 'alias':'rulebook-rid-race-sid'},
				{'path':'/rulebook/:rid/spell', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Spells', 'alias':'rulebook-rid-spell'},
                {'path':'/rulebook/:rid/spell/:sid', 'show':'', 'render':true, 'children':false, 'menu':'Rulebook Spell', 'alias':'rulebook-rid-spell-sid'},
