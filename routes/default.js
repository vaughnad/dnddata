module.exports = {
    setup: (app, db, endpoint) => {
        ...
        app.get(endpoint, (req, res) => {
			...
			html += "<p><span>?guid=X (x = guid) gives a specific item or item list</span></p>";
			html += "<p><span>?limit=X (x = number) gives limited amount of items</span></p>";
			html += "<p>&nbsp;</p>";
            ...
            html += "<p><a href='/skills/tricks'>/skills/tricks</a></p>";
			html += "<p><a href='/spell'>/spell</a> <i>(needs guid)</i></p>";
            html += "<p><a href='/spell/classes'>/spell/classes</a> <i>(needs guid)</i></p>";
            html += "<p><a href='/spell/descriptors'>/spell/descriptors</a> <i>(needs guid)</i></p>";
            html += "<p><a href='/spell/domains'>/spell/domains</a> <i>(needs guid)</i></p>";
			html += "<p><a href='/spells'>/spells</a></p>";
            html += "<p><a href='/spells/descriptors'>/spells/descriptors</a></p>";
            html += "<p><a href='/spells/descriptors/spells'>/spells/descriptors/spell</a> <i>(needs guid)</i></p>";
            html += "<p><a href='/spells/domains'>/spells/domains</a></p>";
            html += "<p><a href='/spells/domains/spells'>/spells/domains/spells</a> <i>(needs guid)</i></p>";
			html += "<p><a href='/spells/schools'>/spells/schools</a></p>";
			html += "<p><a href='/spells/schools/spells'>/spells/schools/spells</a> <i>(needs guid)</i></p>";
