...
module.exports = {
    setup: (app, db, sqlHelper) => {
        ...
        app.get(endpoint, (req, res) => {
            ...
            var sql = `SELECT dnd_characterclassvariant.id AS guid, dnd_characterclass.name, dnd_characterclass.slug, dnd_characterclass.prestige, dnd_rulebook.id AS rulebook_id, dnd_rulebook.name AS rulebook_name, dnd_rulebook.slug AS rulebook_slug, dnd_dndedition.id AS edition_id, dnd_dndedition.name AS edition_name, dnd_dndedition.slug AS edition_slug FROM dnd_characterclassvariant 
